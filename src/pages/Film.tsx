...
const Film = () => {
  ...
  return (
    <div>
      <div className='relative w-full h-[86vh] bg-black'>
        <iframe
      ...
      <div className='container mt-6'>
        <div className='flex items-center justify-between mb-10'>
          ...
          <Link to={`${PATH.film}/${slug}`} className='flex items-center gap-2 text-[#428bca] hover:text-lime-400'>
        ...
        <div className='grid grid-cols-12 gap-3 max-h-[250px] overflow-auto pr-2'>
